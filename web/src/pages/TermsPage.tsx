...
const content: Record<SupportedLanguage, { sections: { title: string; body: string[] }[] }> = {
  en: {
    sections: [
      {
        title: '1. About scriba',
        body: [
          'scriba ("we", "us", or "the Service") is an academic document processing service that offers proofreading and formatting assistance for academic theses and manuscripts. By submitting a document you agree to these Terms of Service in full.',
        ],
      },
      {
        title: '2. Nature of the Service',
        body: [
          'scriba provides automated and assisted suggestions for grammar, style, and document formatting. Our proofreading service identifies potential errors and proposes corrections; our formatting service restructures your document to match a chosen academic guideline (ABNT, APA, MLA, or Chicago).',
      ...
      },
      {
        ...
        body: [
          'scriba makes no representation, warranty, or guarantee — express or implied — that use of the Service will result in a passing grade, approval by a thesis committee, or any other specific academic outcome.',
          'Specifically, and without limitation: (a) we do not guarantee that your document will be free of grammatical, stylistic, or typographical errors after processing; (b) we do not guarantee that the formatted document will fully satisfy the specific requirements of your institution, department, or supervising professor; and (c) we accept no liability for low grades, committee rejection, or any academic or professional consequences arising from the submission of a document processed by scriba.',
      ...
      },
      {
        ...
        body: [
          'To the maximum extent permitted by applicable law, scriba and its officers, employees, agents, and licensors shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to: loss of academic standing, loss of scholarship, loss of employment opportunities, or any other loss arising out of or in connection with your use of the Service.',
          'Our total aggregate liability to you for any claims arising under or related to these Terms shall not exceed the amount paid by you to scriba in the twelve (12) months preceding the claim.',
        ],
      },
      {
        title: '5. User Obligations',
        body: [
          'You represent that you are the author of, or have the legal right to submit, any document you upload to scriba. You agree not to submit documents that contain unlawful content or that infringe the intellectual property rights of third parties.',
      ...
      },
      {
        ...
        body: [
          'You retain all intellectual property rights in your original document. By submitting a document, you grant scriba a limited, non-exclusive licence to process and store your document solely for the purpose of delivering the Service.',
          'scriba does not claim ownership of your content and will not share your documents with third parties except as required to provide the Service or as required by law.',
        ],
      },
      {
        ...
        body: [
          ...
          'Full document processing requires a one-time payment per document as displayed at checkout. All sales are final. Refunds are issued solely at our discretion in cases of documented technical failure attributable to scriba.',
      ...
      },
      {
        ...
        body: [
          ...
          'scriba is not liable for any loss of data resulting from the scheduled deletion of files in accordance with this policy.',
        ],
      },
      {
      ...
      },
      {
        title: '10. Contact',
        body: [
          'If you have questions about these Terms, please contact us at legal@scriba.com.',
        ],
      },
    ],
  },
  'pt-BR': {
    sections: [
      {
        title: '1. Sobre o scriba',
        body: [
          'O scriba ("nós" ou "o Serviço") é um serviço de processamento de documentos acadêmicos que oferece assistência de revisão gramatical e formatação para teses e manuscritos acadêmicos. Ao enviar um documento, você concorda integralmente com estes Termos de Serviço.',
        ],
      },
      {
        title: '2. Natureza do Serviço',
        body: [
          'O scriba oferece sugestões automatizadas e assistidas de gramática, estilo e formatação de documentos. O serviço de revisão identifica possíveis erros e propõe correções; o serviço de formatação reestrutura o documento conforme a norma acadêmica escolhida (ABNT, APA, MLA ou Chicago).',
      ...
      },
      {
        ...
        body: [
          'Na máxima extensão permitida pela legislação aplicável, o scriba e seus sócios, funcionários, agentes e licenciantes não serão responsáveis por quaisquer danos indiretos, incidentais, especiais, consequenciais ou punitivos, incluindo, sem limitação: perda de status acadêmico, perda de bolsa de estudos, perda de oportunidades de emprego ou qualquer outra perda decorrente ou relacionada ao uso do Serviço.',
          'Nossa responsabilidade total perante você por quaisquer reclamações decorrentes ou relacionadas a estes Termos não excederá o valor pago por você ao scriba nos doze (12) meses anteriores à reclamação.',
        ],
      },
      {
        title: '5. Obrigações do Usuário',
        body: [
          'Você declara ser o autor ou ter o direito legal de submeter qualquer documento enviado ao scriba. Você concorda em não enviar documentos com conteúdo ilegal ou que violem direitos de propriedade intelectual de terceiros.',
      ...
      },
      {
        ...
        body: [
          'Você mantém todos os direitos de propriedade intelectual sobre o documento original. Ao enviar um documento, você concede ao scriba uma licença limitada e não exclusiva para processar e armazenar o documento exclusivamente para a prestação do Serviço.',
          'O scriba não reivindica propriedade sobre seu conteúdo e não compartilhará seus documentos com terceiros, exceto quando necessário para a prestação do Serviço ou exigido por lei.',
        ],
      },
      {
        ...
        body: [
          ...
          'O processamento completo do documento requer um pagamento único por documento, conforme exibido no checkout. Todas as vendas são definitivas. Reembolsos são concedidos exclusivamente a nosso critério em casos de falha técnica documentada atribuída ao scriba.',
      ...
      },
      {
        ...
        body: [
          ...
          'O scriba não se responsabiliza por qualquer perda de dados decorrente da exclusão programada de arquivos conforme esta política.',
        ],
      },
      {
      ...
      },
      {
        title: '10. Contato',
        body: [
          'Em caso de dúvidas sobre estes Termos, entre em contato pelo e-mail legal@scriba.com.',
        ],
      },
    ],
  },
    ...
    sections: [
      {
        title: '1. Sobre o scriba',
        body: [
          'O scriba ("nós" ou "o Serviço") é um serviço de processamento de documentos académicos que oferece assistência de revisão gramatical e formatação para teses e manuscritos académicos. Ao enviar um documento, concorda integralmente com estes Termos de Serviço.',
        ],
      },
      {
        title: '2. Natureza do Serviço',
        body: [
          'O scriba oferece sugestões automatizadas e assistidas de gramática, estilo e formatação de documentos. O serviço de revisão identifica possíveis erros e propõe correções; o serviço de formatação reestrutura o documento de acordo com a norma académica escolhida (ABNT, APA, MLA ou Chicago).',
      ...
      },
      {
        ...
        body: [
          'O scriba não presta nenhuma declaração, garantia ou promessa — expressa ou implícita — de que a utilização do Serviço resultará em aprovação, júri favorável ou qualquer outro resultado académico específico.',
      ...
      },
      {
        title: '4. Limitação de Responsabilidade',
        body: [
          'Na máxima extensão permitida pela legislação aplicável, o scriba e os seus sócios, funcionários, agentes e licenciantes não serão responsáveis por quaisquer danos indiretos, incidentais, especiais, consequenciais ou punitivos, incluindo, sem limitação: perda de estatuto académico, perda de bolsa de estudos, perda de oportunidades de emprego ou qualquer outra perda decorrente ou relacionada com a utilização do Serviço.',
          'A nossa responsabilidade total perante o utilizador por quaisquer reclamações decorrentes ou relacionadas com estes Termos não excederá o montante pago pelo utilizador ao scriba nos doze (12) meses anteriores à reclamação.',
        ],
      },
      {
        title: '5. Obrigações do Utilizador',
        body: [
          'O utilizador declara ser o autor ou ter o direito legal de submeter qualquer documento enviado ao scriba. Concorda em não enviar documentos com conteúdo ilegal ou que violem direitos de propriedade intelectual de terceiros.',
      ...
      },
      {
        title: '6. Propriedade Intelectual',
        body: [
          'O utilizador mantém todos os direitos de propriedade intelectual sobre o documento original. Ao enviar um documento, concede ao scriba uma licença limitada e não exclusiva para processar e armazenar o documento exclusivamente para a prestação do Serviço.',
          'O scriba não reivindica a propriedade do seu conteúdo e não partilhará os seus documentos com terceiros, exceto quando necessário para a prestação do Serviço ou exigido por lei.',
        ],
      },
      {
        title: '7. Pagamento e Reembolsos',
        body: [
          'Uma avaliação gratuita única está disponível para a primeira página de qualquer documento, por conta, em qualquer um dos serviços. Não é necessário cartão de crédito para a avaliação.',
          'O processamento completo do documento requer um pagamento único por documento, conforme apresentado no checkout. Todas as vendas são definitivas. Os reembolsos são concedidos exclusivamente a nosso critério em casos de falha técnica documentada atribuída ao scriba.',
      ...
      },
      {
        ...
        body: [
          ...
          'O scriba não se responsabiliza por qualquer perda de dados resultante da eliminação programada de ficheiros nos termos desta política.',
        ],
      },
      {
      ...
      },
      {
        title: '10. Contacto',
        body: [
          'Em caso de dúvidas sobre estes Termos, contacte-nos através do e-mail legal@scriba.com.',
        ],
      },
    ],
  },
